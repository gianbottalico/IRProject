...
def createTables(db):
	...
	rawSqlQuery(db, '''
		CREATE TABLE IF NOT EXISTS flat_photos (
			...
			c_exposure     double precision DEFAULT NULL,
			c_aperture     double precision DEFAULT NULL,
			c_focal_length double precision DEFAULT NULL,
			c_iso_speed    double precision DEFAULT NULL,
